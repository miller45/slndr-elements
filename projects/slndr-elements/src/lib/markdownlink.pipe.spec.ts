  ...
  describe('MarkdownLinkPipe', () => {
    ...
    describe('with link opening in new tab', () => {
      ...
      it('converts multiple markdown links in the middle', () => {
        const converter = new MarkdownLinkPipe(domSanitizer);
        expect(converter.transform('Text before [Link1](https://www.link1.com) Text Middle [Link2](https://www.link2.com) Text After')).
        toEqual(`Text before <a href="https://www.link1.com" rel="noreferrer" target="_blank">Link1</a> Text Middle <a href="https://www.link2.com" rel="noreferrer" target="_blank">Link2</a> Text After`);
      });
